    ...
    <aside className="flex-none w-[14.5rem] px-4 py-8 h-full flex flex-col">
      ...
      <nav className="flex flex-col py-6 space-y-2">
        <NavLink
          label="Dashboard"
          href="/dash"
          icon={<LuLayoutDashboard size={21} color="#707070" />}
        />
        <h2 className="text-sm font-medium pt-4 pb-1 px-3">Manage</h2>
        <NavLink
          label="Bookings"
          href="/bookings"
          icon={<LuBookPlus size={21} color="#707070" />}
        />
        <NavLink
          label="Customers"
          href="/customers"
          icon={<LuUser size={21} color="#707070" />}
        />
        <NavLink
          label="Packages"
          href="/packages"
          icon={<LuPackage size={21} color="#707070" />}
        />
        <h2 className="text-sm font-medium pt-4 pb-1 px-3">Your Account</h2>
        <NavLink
          label="Settings"
          href="/settings"
          icon={<LuSettings size={21} color="#707070" />}
        />
      </nav>
